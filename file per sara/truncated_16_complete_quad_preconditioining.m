...
for j =1:N+1
    ...
    last_vals = conv_ord1_ex(max(end-6,1):end);
    ...
    last_vals = conv_ord1_df1(max(end-6,1):end);
    ...
    last_vals = conv_ord1_df2(max(end-6,1):end);
...
% 
%     plot(1:7,conv_ord_ex, 'Color', 'b', 'LineWidth', 1.5);
%     hold on;
%     for i =1:6 
...
%         plot(1:7,conv_ord_fd1, '-', 'Color', 'r', 'LineWidth', 1.5);
% 
%         hold on;
%         plot(1:7,conv_ord_fd2, '-o', 'Color', 'g', 'LineWidth', 1.5);
%         hold on;
%     end
% 
% 
...
disp('Average computation times table (only for successful runs): F16, Preconditioning, n=10^3, quad');
disp(T1);

% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Time_tabel_f16_3_quad.csv', 'WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F16 Preconditioning, n=10^3, quad');
disp(T2);

% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Iteration_tabel_f16_3_quad.csv', 'WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation fmin value table (only for successful runs): F16, Preconditioning, n=10^3, quad');
disp(T3);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F16 Preconditioning, n=10^3, quad');
disp(T10);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F16, Preconditioning, n=10^3, quad');
disp(T11);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F16, Preconditioning, n=10^3, quad');
disp(T12);
...
% Visualizza la tabella
disp('Number of converged : F16, Preconditioning, n=10^3, quad');
disp(T13);

writetable(T1, 'results_f16P_quad.xlsx', 'Sheet', 'time_3','WriteRowNames', true);
writetable(T2, 'results_f16P_quad.xlsx', 'Sheet', 'niter_3','WriteRowNames', true);
writetable(T3, 'results_f16P_quad.xlsx', 'Sheet', 'f_val_3','WriteRowNames', true);
writetable(T10, 'results_f16P_quad.xlsx', 'Sheet', 'viol_3','WriteRowNames', true);
writetable(T11, 'results_f16P_quad.xlsx', 'Sheet', 'bt_3','WriteRowNames', true);
writetable(T12, 'results_f16P_quad.xlsx', 'Sheet', 'cg_3','WriteRowNames', true);
writetable(T13, 'results_f16P_quad.xlsx', 'Sheet', 'n_conv3','WriteRowNames', true);
...
for j =1:N+1
    ...
    last_vals = conv_ord2_ex(max(end-6,1):end);
    ...
    last_vals = conv_ord2_df1(max(end-6,1):end);
    ...
    last_vals = conv_ord2_df2(max(end-6,1):end);
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F16 Preconditioining, n=10^4, quad');
disp(T4);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F16 Preconditioning, n=10^4, quad');
disp(T5);
...
% Visualizza la tabella
disp('Average computation fmin value table (only for successful runs): F16, Preconditioning, n=10^4, quad');
disp(T6);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F16, Preconditioning, n=10^4, quad');
disp(T14);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F16, Preconditioning, n=10^4, quad');
disp(T15);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F16, Preconditioning, n=10^4, quad');
disp(T16);
...
% Visualizza la tabella
disp('Number of converged : F16, Preconditioning, n=10^4, quad');
disp(T17);

writetable(T4, 'results_f16P_quad.xlsx', 'Sheet', 'time_4','WriteRowNames', true);
writetable(T5, 'results_f16P_quad.xlsx', 'Sheet', 'niter_4','WriteRowNames', true);
writetable(T6, 'results_f16P_quad.xlsx', 'Sheet', 'f_val_4','WriteRowNames', true);
writetable(T14, 'results_f16P_quad.xlsx', 'Sheet', 'viol_4','WriteRowNames', true);
writetable(T15, 'results_f16P_quad.xlsx', 'Sheet', 'bt_4','WriteRowNames', true);
writetable(T16, 'results_f16P_quad.xlsx', 'Sheet', 'cg_4','WriteRowNames', true);
writetable(T17, 'results_f16P_quad.xlsx', 'Sheet', 'n_conv4','WriteRowNames', true);
...
for j =1:N+1
    ...
    last_vals = conv_ord3_ex(max(end-6,1):end);
    ...
    last_vals = conv_ord3_df1(max(end-6,1):end);
    ...
    last_vals = conv_ord3_df2(max(end-6,1):end);
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F16, Preconditioning, n=10^5, quad');
disp(T7);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F16, Preconditioning, n=10^5, quad');
disp(T8);
...
% Visualizza la tabella
disp('Average computation fmin value table (only for successful runs): F16, Preconditioning, n=10^5, quad');
disp(T9);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F16, Preconditioning, n=10^5, quad');
disp(T18);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F16, Preconditioning, n=10^5, quad');
disp(T19);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F16, Preconditioning, n=10^5, quad');
disp(T20);
...
% Visualizza la tabella
disp('Number of converged : F16, Preconditioning, n=10^5, quad');
disp(T21);

writetable(T7, 'results_f16P_quad.xlsx', 'Sheet', 'time_5','WriteRowNames', true);
writetable(T8, 'results_f16P_quad.xlsx', 'Sheet', 'niter_5','WriteRowNames', true);
writetable(T9, 'results_f16P_quad.xlsx', 'Sheet', 'f_val_5','WriteRowNames', true);
writetable(T18, 'results_f16P_quad.xlsx', 'Sheet', 'viol_5','WriteRowNames', true);
writetable(T19, 'results_f16P_quad.xlsx', 'Sheet', 'bt_5','WriteRowNames', true);
writetable(T20, 'results_f16P_quad.xlsx', 'Sheet', 'cg_5','WriteRowNames', true);
writetable(T21, 'results_f16P_quad.xlsx', 'Sheet', 'n_conv5','WriteRowNames', true);
...
writetable(T_compare, 'results_f16P_quad.xlsx', 'Sheet', 'ExactComparison', 'WriteRowNames', true);
