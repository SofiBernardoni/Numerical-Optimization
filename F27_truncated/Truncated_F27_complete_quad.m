...
F = @(x) F27(x);  % Defining F27 as function handle
JF_gen = @(x,exact,fin_dif2,h) JF27(x,exact,fin_dif2,h); % Defining JF27 as function handle 
...
mat_conv1_ex=zeros(15,N+1); %matrix with che last 15 values of rate of convergence for the starting point
...
mat_conv1_fd1=cell(6,N+1);%matrix with che last 15 values of rate of convergence for the starting point
...
mat_conv1_fd2=cell(6,N+1);%matrix with che last 15 values of rate of convergence for the starting point
...
disp('Average computation violation  table (only for successful runs): F27, n=10^3, quadratic');
disp(T10);
...
disp('Average computation bt iteration table (only for successful runs): F27, n=10^3, quadratic');
disp(T11);
...
disp('Average computation cg iteration table (only for successful runs): F27, n=10^3, quadratic');
disp(T12);
...
disp('Average computation fmin value table (only for successful runs): F27, n=10^4, quadratic');
disp(T6);
...
disp('Average computation violation  table (only for successful runs): F27, n=10^4, quadratic');
disp(T14);
...
disp('Average computation bt iteration table (only for successful runs): F27, n=10^4, quadratic');
disp(T15);
...
disp('Average computation cg iteration table (only for successful runs): F27, n=10^4, quadratic');
disp(T16);
...
disp('Number of converged : F27, n=10^4, quadratic');
disp(T17);
%save the table if a file xlsx
writetable(T4, 'results_f27_quad.xlsx', 'Sheet', 'time_4','WriteRowNames', true);
writetable(T5, 'results_f27_quad.xlsx', 'Sheet', 'niter_4','WriteRowNames', true);
writetable(T6, 'results_f27_quad.xlsx', 'Sheet', 'f_val_4','WriteRowNames', true);
writetable(T14, 'results_f27_quad.xlsx', 'Sheet', 'v_4','WriteRowNames', true);
writetable(T15, 'results_f27_quad.xlsx', 'Sheet', 'bt_4','WriteRowNames', true);
writetable(T16, 'results_f27_quad.xlsx', 'Sheet', 'cg_4','WriteRowNames', true);
writetable(T17, 'results_f27_quad.xlsx', 'Sheet', 'n_conv4','WriteRowNames', true);
...
disp('Average computation bt iteration table (only for successful runs): F27, n=10^5, quadratic');
disp(T19);
...
disp('Average computation cg iteration table (only for successful runs): F27, n=10^5, quadratic');
disp(T20);
...
disp('Number of converged : F27, n=10^5, quadratic');
disp(T21);
%save the tables

writetable(T7, 'results_f27_quad.xlsx', 'Sheet', 'time_5','WriteRowNames', true);
writetable(T8, 'results_f27_quad.xlsx', 'Sheet', 'niter_5','WriteRowNames', true);
writetable(T9, 'results_f27_quad.xlsx', 'Sheet', 'f_val_5','WriteRowNames', true);
writetable(T18, 'results_f27_quad.xlsx', 'Sheet', 'v_5','WriteRowNames', true);
writetable(T19, 'results_f27_quad.xlsx', 'Sheet', 'bt_5','WriteRowNames', true);
writetable(T20, 'results_f27_quad.xlsx', 'Sheet', 'cg_5','WriteRowNames', true);
writetable(T21, 'results_f27_quad.xlsx', 'Sheet', 'n_conv5','WriteRowNames', true);
...
writetable(T_compare, 'results_f27_quad.xlsx', 'Sheet', 'ExactComparison', 'WriteRowNames', true);
