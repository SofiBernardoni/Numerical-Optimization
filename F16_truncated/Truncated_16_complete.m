...
disp('Average computation violation  table (only for successful runs): F16, n=10^4, suplinear');
disp(T14);
...
disp('Average computation bt iteration table (only for successful runs): F16, n=10^4, superlinear');
disp(T15);
...
disp('Average computation cg iteration table (only for successful runs): F16, n=10^4, superlinear');
disp(T16);
...
disp('Number of converged : F16, n=10^4, superlinear');
disp(T17);
%save the table in a file xlsx
