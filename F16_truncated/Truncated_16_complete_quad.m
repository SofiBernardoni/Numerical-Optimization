...
disp('Average computation iteration table (only for successful runs): F16, n=10^3, quadratic');
disp(T2);
...
disp('Average computation violation  table (only for successful runs): F16, n=10^3, quadratic');
disp(T10);
...
disp('Average computation bt iteration table (only for successful runs): F16, n=10^3, quadratic');
disp(T11);
...
disp('Average computation bt iteration table (only for successful runs): F16, n=10^4, quadratic');
disp(T15);
...
disp('Average computation cg iteration table (only for successful runs): F16, n=10^4, quadratic');
disp(T16);
...
disp('Number of converged : F16, n=10^4, quadratic');
disp(T17);
...
disp('Average computation violation  table (only for successful runs): F16, n=10^5, quadratic');
disp(T18);
...
disp('Average computation bt iteration table (only for successful runs): F16, n=10^5, quadratic');
disp(T19);
...
disp('Average computation cg iteration table (only for successful runs): F16, n=10^5, quadratic');
disp(T20);
...
disp('Number of converged : F16, n=10^5, quadratic');
disp(T21);
%save the tables

writetable(T7, 'results_f16_quad.xlsx', 'Sheet', 'time_5','WriteRowNames', true);
...
writetable(T18, 'results_f16_quad.xlsx', 'Sheet', 'viol_5','WriteRowNames', true);
writetable(T19, 'results_f16_quad.xlsx', 'Sheet', 'bt_5','WriteRowNames', true);
writetable(T20, 'results_f16_quad.xlsx', 'Sheet', 'cg_5','WriteRowNames', true);
writetable(T21, 'results_f16_quad.xlsx', 'Sheet', 'n_conv5','WriteRowNames', true);
