...
writetable(T10, 'results_f79P_quad.xlsx', 'Sheet', 'v_3','WriteRowNames', true);
writetable(T11, 'results_f79P_quad.xlsx', 'Sheet', 'bt_3','WriteRowNames', true);
writetable(T12, 'results_f79P_quad.xlsx', 'Sheet', 'cg_3','WriteRowNames', true);
writetable(T13, 'results_f79P_quad.xlsx', 'Sheet', 'n_conv3','WriteRowNames', true);
...
writetable(T14, 'results_f79P_quad.xlsx', 'Sheet', 'v_4','WriteRowNames', true);
writetable(T15, 'results_f79P_quad.xlsx', 'Sheet', 'bt_4','WriteRowNames', true);
writetable(T16, 'results_f79P_quad.xlsx', 'Sheet', 'cg_4','WriteRowNames', true);
writetable(T17, 'results_f79P_quad.xlsx', 'Sheet', 'n_conv4','WriteRowNames', true);
...
writetable(T18, 'results_f79P_quad.xlsx', 'Sheet', 'v_5','WriteRowNames', true);
writetable(T19, 'results_f79P_quad.xlsx', 'Sheet', 'bt_5','WriteRowNames', true);
writetable(T20, 'results_f79P_quad.xlsx', 'Sheet', 'cg_5','WriteRowNames', true);
writetable(T21, 'results_f79P_quad.xlsx', 'Sheet', 'n_conv5','WriteRowNames', true);
