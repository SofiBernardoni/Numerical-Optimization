...
% title('F79 Preconditioing 10^3 suplin');
% xlabel('Iterazione');
...
disp('Average computation times table (only for successful runs): F79P Preconditioning, n=10^3, superlinear');
disp(T1);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F79P, n=10^3, superlinear');
disp(T2);
...
% Visualizza la tabella
disp('Average computation fmin value table (only for successful runs): F79P, n=10^3, superlinear');
disp(T3);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F79P, n=10^3, suplin');
disp(T10);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F79P, n=10^3, suplin');
disp(T11);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F79P, n=10^3, suplin');
disp(T12);
...
% Visualizza la tabella
disp('Number of converged : F79P, n=10^3, suplin');
disp(T13);
...
% 
% % Aggiungi titolo e legenda
% title('F79 Preconditioing 10^4 suplin');
% xlabel('Iterazione');
% ylabel('Ordine di Convergenza');
% legend({'Exact Derivatives', 'dif fin_1', 'dif fin_2'}, 'Location', 'Best');
% grid on;
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F79P, n=10^4, superlinear');
disp(T4);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F79P, n=10^4, superlinear');
disp(T5);
...
% Visualizza la tabella
disp('Average computation fmin value table (only for successful runs): F79P, n=10^4, superlinear');
disp(T6);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F79P, n=10^4, suplin');
disp(T14);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F79P, n=10^4, suplin');
disp(T15);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F79P, n=10^4, suplin');
disp(T16);
...
% Visualizza la tabella
disp('Number of converged : F79P, n=10^4, suplin');
disp(T17);

writetable(T4, 'results_f79P_suplin.xlsx', 'Sheet', 'time_4','WriteRowNames', true);
writetable(T5, 'results_f79P_suplin.xlsx', 'Sheet', 'niter_4','WriteRowNames', true);
writetable(T6, 'results_f79P_suplin.xlsx', 'Sheet', 'f_val_4','WriteRowNames', true);
writetable(T14, 'results_f79P_suplin.xlsx', 'Sheet', 'v_4','WriteRowNames', true);
writetable(T15, 'results_f79P_suplin.xlsx', 'Sheet', 'bt_4','WriteRowNames', true);
writetable(T16, 'results_f79P_suplin.xlsx', 'Sheet', 'cg_4','WriteRowNames', true);
writetable(T17, 'results_f79P_suplin.xlsx', 'Sheet', 'n_conv4','WriteRowNames', true);
...
% 
% % Aggiungi titolo e legenda
% title('F79 Preconditioing 10^5 suplin');
% xlabel('Iterazione');
% ylabel('Ordine di Convergenza');
% legend({'Exact Derivatives', 'dif fin_1', 'dif fin_2'}, 'Location', 'Best');
% grid on;
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F79P, n=10^5, superlinear');
disp(T7);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F79P, n=10^5, suplin');
disp(T18);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F79P, n=10^5, suplin');
disp(T19);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F79P, n=10^5, suplin');
disp(T20);
...
% Visualizza la tabella
disp('Number of converged : F79P, n=10^5, suplin');
disp(T17);

writetable(T7, 'results_f79P_suplin.xlsx', 'Sheet', 'time_5','WriteRowNames', true);
writetable(T8, 'results_f79P_suplin.xlsx', 'Sheet', 'niter_5','WriteRowNames', true);
writetable(T9, 'results_f79P_suplin.xlsx', 'Sheet', 'f_val_5','WriteRowNames', true);
writetable(T18, 'results_f79P_suplin.xlsx', 'Sheet', 'v_5','WriteRowNames', true);
writetable(T19, 'results_f79P_suplin.xlsx', 'Sheet', 'bt_5','WriteRowNames', true);
writetable(T20, 'results_f79P_suplin.xlsx', 'Sheet', 'cg_5','WriteRowNames', true);
writetable(T21, 'results_f79P_suplin.xlsx', 'Sheet', 'n_conv5','WriteRowNames', true);
...
writetable(T_compare, 'results_f79P_suplin.xlsx', 'Sheet', 'ExactComparison', 'WriteRowNames', true);
