...
mat_conv_fd1=cell(6, N+1);%matrix with che last 12 values of rate of convergence for the starting point
...
mat_conv_fd2=cell(6,N+1);%matrix with che last 12 values of rate of convergence for the starting point
...
% visualization
disp('Average computation times table (only for successful runs): F79P, n=10^3, superlinear');
disp(T1);
...
disp('Average computation iteration table (only for successful runs): F79P, n=10^3, suplin');
disp(T2);
...
disp('Average computation fmin value table (only for successful runs): F79P, n=10^3, suplin');
disp(T3);
...
disp('Average computation violation  table (only for successful runs): F79P, n=10^3, superlinear');
disp(T10);
...
disp('Average computation bt iteration table (only for successful runs): F79P, n=10^3, superlinear');
disp(T11);
...
disp('Average computation violation  table (only for successful runs): F79P, n=10^4, suplinear');
disp(T14);
...
disp('Average computation bt iteration table (only for successful runs): F79P, n=10^4, superlinear');
disp(T15);
...
disp('Average computation cg iteration table (only for successful runs): F79P, n=10^4, superlinear');
disp(T16);
...
disp('Number of converged : F79P, n=10^4, superlinear');
disp(T17);
%save the table in a file xlsx
...
disp('Average computation cg iteration table (only for successful runs): F79P, n=10^5, superlinear');
disp(T20);
...
disp('Number of converged : F79P, n=10^5, superlinear');
disp(T21);
...
%% Creation of the table with the result of exact derivatives
