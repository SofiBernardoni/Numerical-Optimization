...
disp('Average computation times table (only for successful runs): F79, n=10^3, superlinear');
disp(T1);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F79, n=10^3, superlinear');
disp(T10);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F79, n=10^3, superlinear');
disp(T11);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F79, n=10^3, superlinear');
disp(T12);
...
% Visualizza la tabella
disp('Number of converged : F79, n=10^3, superlinear');
disp(T13);
...
writetable(T10, 'results_f79_suplin.xlsx', 'Sheet', 'viol_3','WriteRowNames', true);
writetable(T11, 'results_f79_suplin.xlsx', 'Sheet', 'bt_3','WriteRowNames', true);
writetable(T12, 'results_f79_suplin.xlsx', 'Sheet', 'cg_3','WriteRowNames', true);
writetable(T13, 'results_f79_suplin.xlsx', 'Sheet', 'n_conv3','WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation violation  table (only for successful runs): F79, n=10^4, suplinear');
disp(T14);
...
% Visualizza la tabella
disp('Average computation bt iteration table (only for successful runs): F79, n=10^4, superlinear');
disp(T15);
...
% Visualizza la tabella
disp('Average computation cg iteration table (only for successful runs): F79, n=10^4, superlinear');
disp(T16);
