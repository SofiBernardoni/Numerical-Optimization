...
[x2, f2, gradf2_norm, k2, xseq2, btseq2,cgiterseq2,c2,flag2,v2] = truncated_newton(x0_a, f_Rosen, gradf_Rosen, Hessf_Rosen, kmax, tolgrad, fterms_quad, cg_maxit,z0, c1, rho, btmax);
...
[x3, f3, gradf3_norm, k3, xseq3, btseq3,cgiterseq3,c3,flag3,v3] = truncated_newton(x0_b, f_Rosen, gradf_Rosen, Hessf_Rosen, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
