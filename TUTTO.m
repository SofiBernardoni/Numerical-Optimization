...
% 
% % Visualizza la tabella
% disp('Average computation iteration table (only for successful runs): F16, n=10^3, quad');
% disp(T2);
% 
% % (Opzionale) Salva la tabella in un file CSV
...
% 
% % Visualizza la tabella
% disp('Average computation fmin value table (only for successful runs): F16, n=10^3, quad');
% disp(T3);
% 
% % (Opzionale) Salva la tabella in un file CSV
...
% %writetable(T, 'Fminvalue_tabel_f16_3_quad.csv', 'WriteRowNames', true);
% 
% writetable(T4, 'results_f16_quad.xlsx', 'Sheet', 'time_4','WriteRowNames', true);
% writetable(T5, 'results_f16_quad.xlsx', 'Sheet', 'niter_4','WriteRowNames', true);
% writetable(T6, 'results_f16_quad.xlsx', 'Sheet', 'f_val_4','WriteRowNames', true);
% 
...
% writetable(T_compare, 'results_f16_quad.xlsx', 'Sheet', 'ExactComparison', 'WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F27, n=10^3, superlinear');
disp(T1);

% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Time_tabel_f27_3_suplin.csv', 'WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F27, n=10^3, superlinear');
disp(T2);

% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Iteration_tabel_f27_3_suplin.csv', 'WriteRowNames', true);
...
% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Fminvalue_tabel_f27_3_suplin.csv', 'WriteRowNames', true);

writetable(T1, 'results_f27_3_suplin.xlsx', 'Sheet', 'time_3','WriteRowNames', true);
writetable(T2, 'results_f27_3_suplin.xlsx', 'Sheet', 'niter_3','WriteRowNames', true);
writetable(T3, 'results_f27_3_suplin.xlsx', 'Sheet', 'f_val_3','WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F27, n=10^4, superlinear');
disp(T4);
...
writetable(T4, 'results_f27_3_suplin.xlsx', 'Sheet', 'time_4','WriteRowNames', true);
writetable(T5, 'results_f27_3_suplin.xlsx', 'Sheet', 'niter_4','WriteRowNames', true);
writetable(T6, 'results_f27_3_suplin.xlsx', 'Sheet', 'f_val_4','WriteRowNames', true);
...
writetable(T7, 'results_f27_3_suplin.xlsx', 'Sheet', 'time5','WriteRowNames', true);
writetable(T8, 'results_f27_3_suplin.xlsx', 'Sheet', 'niter_5','WriteRowNames', true);
writetable(T9, 'results_f27_3_suplin.xlsx', 'Sheet', 'f_val_5','WriteRowNames', true);
...
% Salvataggio su Excel
writetable(T_compare, 'results_f27_3_suplin.xlsx', 'Sheet', 'ExactComparison', 'WriteRowNames', true);

%% FUNCTION 27  QUADRATIC (with different initial points)- with exact derivatives and finite differences
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F27, n=10^3, quadratic');
disp(T1);

% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Time_tabel_f27_3_quad.csv', 'WriteRowNames', true);
...
% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Iteration_tabel_f27_3_quad.csv', 'WriteRowNames', true);
...
% (Opzionale) Salva la tabella in un file CSV
%writetable(T, 'Fminvalue_tabel_f27_3_quad.csv', 'WriteRowNames', true);

writetable(T1, 'results_f27_3_quad.xlsx', 'Sheet', 'time_3','WriteRowNames', true);
writetable(T2, 'results_f27_3_quad.xlsx', 'Sheet', 'niter_3','WriteRowNames', true);
writetable(T3, 'results_f27_3_quad.xlsx', 'Sheet', 'f_val_3','WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F27, n=10^4, quadratic');
disp(T5);
...
writetable(T4, 'results_f27_3_quad.xlsx', 'Sheet', 'time_4','WriteRowNames', true);
writetable(T5, 'results_f27_3_quad.xlsx', 'Sheet', 'niter_4','WriteRowNames', true);
writetable(T6, 'results_f27_3_quad.xlsx', 'Sheet', 'f_val_4','WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation times table (only for successful runs): F27, n=10^5, quadratic');
disp(T7);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F27, n=10^5, quadratic');
disp(T8);
...
writetable(T7, 'results_f27_3_quad.xlsx', 'Sheet', 'time5','WriteRowNames', true);
writetable(T8, 'results_f27_3_quad.xlsx', 'Sheet', 'niter_5','WriteRowNames', true);
writetable(T9, 'results_f27_3_quad.xlsx', 'Sheet', 'f_val_5','WriteRowNames', true);
...
% Salvataggio su Excel
writetable(T_compare, 'results_f27_3_quad.xlsx', 'Sheet', 'ExactComparison', 'WriteRowNames', true);
...
% Visualizza la tabella
disp('Average computation iteration table (only for successful runs): F79, n=10^3, suplin');
disp(T2);
...
% Visualizza la tabella
disp('Average computation fmin value table (only for successful runs): F79, n=10^3, suplin');
disp(T3);
...
writetable(T1, 'results_f79_Precond_quad.xlsx', 'Sheet', 'time_3','WriteRowNames', true);
writetable(T2, 'results_f79_Precond_quad.xlsx', 'Sheet', 'niter_3','WriteRowNames', true);
writetable(T3, 'results_f79_Precond_quad.xlsx', 'Sheet', 'f_val_3','WriteRowNames', true);
...
writetable(T4, 'results_f79_Precond_quad.xlsx', 'Sheet', 'time_4','WriteRowNames', true);
writetable(T5, 'results_f79_Precond_quad.xlsx', 'Sheet', 'niter_4','WriteRowNames', true);
writetable(T6, 'results_f79_Precond_quad.xlsx', 'Sheet', 'f_val_4','WriteRowNames', true);
...
writetable(T7, 'results_f79_Precond_quad.xlsx', 'Sheet', 'time5','WriteRowNames', true);
writetable(T8, 'results_f79_Precond_quad.xlsx', 'Sheet', 'niter_5','WriteRowNames', true);
writetable(T9, 'results_f79_Precond_quad.xlsx', 'Sheet', 'f_val_5','WriteRowNames', true);
