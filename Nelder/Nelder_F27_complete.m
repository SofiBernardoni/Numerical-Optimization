...
times_10 = zeros(1,N+1); %vector for saving times
vec_10 = zeros(1,N+1); %vector for saving minimum point
vec_iter_10 = zeros(1,N+1); %vector for saving iteration
