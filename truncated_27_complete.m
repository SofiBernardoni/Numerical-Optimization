...
for j =1:N+1
    ...
    % EXACT DERIVATIVES
    tic;
    [x1, f1, gradf_norm1, k1, xseq1, btseq1,cgiterseq1,conv_ord1,flag1, converged1, violations1] = truncated_newton_27(Mat_points(:,j), F, JF_ex, true,false,0, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
    vec_times1_ex(j)=toc;
    ...
    tic;
    [x1, f1, gradf_norm1, k1, xseq1, btseq1,cgiterseq1,conv_ord1,flag1, converged1, violations1] = truncated_newton_27(Mat_points(:,j), F, JF, false,false,h, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
    ...
    JF=@(x) JF_fd2(x,h);
    tic;
    [x1, f1, gradf_norm1, k1, xseq1, btseq1,cgiterseq1,conv_ord1,flag1, converged1, violations1] = truncated_newton_27(Mat_points(:,j), F, JF, false,true,h, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
...
for j =1:N+1
    ...
    % EXACT DERIVATIVES
    tic;
    [x2, f2, gradf_norm2, k2, xseq2, btseq2,cgiterseq2,conv_ord2,flag2, converged2, violations2] = truncated_newton_27(Mat_points(:,j), F, JF_ex, true,false,0, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
    vec_times2_ex(j)=toc;
    ...
    tic;
    [x2, f2, gradf_norm2, k2, xseq2, btseq2,cgiterseq2,conv_ord2,flag2, converged2, violations2] = truncated_newton_27(Mat_points(:,j), F, JF, false,false,h, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
    ...
    tic;
    [x2, f2, gradf_norm2, k2, xseq2, btseq2,cgiterseq2,conv_ord2,flag2, converged2, violations2] = truncated_newton_27(Mat_points(:,j), F, JF, false,true,h, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
...
for j =1:N+1
    ...
    % EXACT DERIVATIVES
    tic;
    [x3, f3, gradf_norm3, k3, xseq3, btseq3,cgiterseq3,conv_ord3,flag3, converged3, violations3] = truncated_newton_27(Mat_points(:,j), F, JF_ex, true, false,0, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
    vec_times3_ex(j)=toc;
    ...
    tic;
    [x3, f3, gradf_norm3, k3, xseq3, btseq3,cgiterseq3,conv_ord3,flag3, converged3, violations3] = truncated_newton_27(Mat_points(:,j), F, JF, false,false,h, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
    mat_times2_fd1(i/2,j)=toc;
    ...
    tic;
    [x3, f3, gradf_norm3, k3, xseq3, btseq3,cgiterseq3,conv_ord3,flag3, converged3, violations3] = truncated_newton_27(Mat_points(:,j), F, JF, false,true,h, kmax, tolgrad, fterms_suplin, cg_maxit,z0, c1, rho, btmax);
